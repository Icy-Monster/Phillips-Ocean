This is an implementation of an Ocean-Spectra, the Phillips spectrum to be exact.It uses inverse fast Fourier transforms (FFT) to efficiently and quickly generate waves.
